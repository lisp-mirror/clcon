...
Компиляция одной функции лиспа, исходник которой находится в редакторе:

В редакторе встать внутри ф-ии и в консоли подать команду .o compile-current-defun
