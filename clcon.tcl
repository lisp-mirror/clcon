 ...
 переподключиться к текстовому лисп-серверу SWANK или подождите нормального завершения вашего вычисления"}
  ...
  ::tkcon::Prompt"
    ...
    foreach m [list [menu $w.справка] [menu $w.pop.справка]] {
        ...
        $m add separator
        $m add command -label "5.Перевод документации по tcl/tk 8.0 (устар.)" -command {::tkcon::EvalInSwankAsync "(CLCO::OPEN-URL \"file:///$::tkcon::YarRoot/док/книги/tcl-tk/i_gu10.html\")" {} t} -underline 0
